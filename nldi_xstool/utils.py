...
def project_point(x, y, transformToRaster):
    ...
    print('projected point:',type(projected_point), projected_point)

    projected_xy = projected_point.coords[:][0]
    orig_xy = point_geom.coords[:][0]
    print('orig_xy', type(orig_xy), orig_xy, type(orig_xy[0]))
    print(type(projected_xy[0]))
